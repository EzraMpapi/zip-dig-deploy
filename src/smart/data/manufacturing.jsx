...
export const bomsSeed = [
  {
    id: "BOM-01",
    product: "Cold Chain Storage Unit",
    outputUnit: "unit",
    components: [
      { sku: "HDW-2209", qty: 1 },
      { sku: "HDW-2207", qty: 2 },
  ...
  {
    id: "BOM-03",
    product: "Fleet Tracking Install Kit",
    outputUnit: "kit",
    components: [{ sku: "HDW-2204", qty: 1 }],
    laborCost: 40,
  },
];
...
export const qcInspectionsSeed = [
  ...
  },
  {
    id: "QC-02",
    workOrderId: "WO-298",
    inspector: "Grace Mmbaga",
    result: "Rework",
    defectsFound: 1,
    notes: "One unit had a loose seal — reworked before release.",
    date: "2026-06-08",
  },
];
...
export const maintenanceSeed = [
  ...
  {
    id: "MT-02",
    machine: "CNC Panel Cutter #1",
    type: "Preventive",
    technician: "Grace Mmbaga",
    date: "2026-05-15",
    cost: 85,
    notes: "Routine blade replacement and calibration",
