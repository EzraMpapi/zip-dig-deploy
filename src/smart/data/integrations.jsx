...
export const INTEGRATION_CONNECTIONS = [
  {
    ...
    functional: false,
    fields: [
      { key: "tenantId", label: "Azure AD Tenant ID", placeholder: "contoso.onmicrosoft.com" },
      {
        key: "clientId",
        label: "App (client) ID",
    ...
    requirement:
      "Real sign-in and Outlook/Calendar/OneDrive access need an Azure AD app registration with a hosted redirect URI and a server-side token exchange — not achievable from a static page alone.",
  },
  {
    id: "google-workspace",
    ...
    requirement:
      "Gmail/Calendar/Drive access needs a Google Cloud OAuth client and a registered redirect URI — the identical backend requirement as Microsoft 365.",
  },
  {
    id: "slack",
    name: "Slack",
  ...
  },
  {
    ...
    fields: [
      {
        key: "apiKey",
        label: "Server-to-Server OAuth Account ID",
        placeholder: "xxxxxxxxxxxxxxxxxx",
      },
    ],
    requirement:
      "Creating meetings programmatically needs a Zoom Server-to-Server OAuth app and a backend to hold its credentials — the same category of requirement as Microsoft 365. What's genuinely real without one: the Collaboration Hub's Shared Calendar (section 37) has a real meeting-link field — paste in a Zoom link generated the normal way, and the calendar shows a working Join button.",
  },
  {
  ...
  },
  {
    ...
    requirement:
      "Opens your real Stripe-hosted payment page in a new tab. Processing a card charge inside this app (not just linking out) needs a server holding your Stripe secret key.",
  },
  {
    id: "paypal",
    name: "PayPal",
    ...
    requirement:
      "Opens your real PayPal.me page in a new tab. A fully embedded checkout needs PayPal's SDK and, for anything beyond the simplest flow, server-side order verification.",
  },
  {
  ...
  },
  {
    ...
    fields: [
      {
        key: "terminalId",
        label: "Terminal / Merchant ID",
        placeholder: "e.g. Square, Clover terminal ID",
      },
    ],
    requirement:
