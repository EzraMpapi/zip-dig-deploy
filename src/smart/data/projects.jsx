...
export const projectsSeed = [
  {
    ...
    client: "Kilimo Fresh Distributors",
    status: "Active",
  ...
  },
  {
    ...
    client: "Baraka Hotels & Resorts",
    status: "Planning",
    startDate: "2026-07-10",
    endDate: "2026-09-30",
    budget: 28000,
    manager: "Grace Mmbaga",
  },
];
...
export const projectTasksSeed = [
  {
    id: "TSK-01",
    projectId: "PRJ-01",
    title: "Site survey — cold storage bay",
  ...
  },
  {
    id: "TSK-03",
    projectId: "PRJ-01",
    title: "Commission refrigeration units",
    assignee: "David Chen",
    status: "To Do",
    priority: "Medium",
    dueDate: "2026-07-25",
  },
  {
    id: "TSK-04",
    projectId: "PRJ-02",
    title: "Install GPS units on fleet",
    assignee: "S. Kileo",
    status: "In Progress",
    priority: "High",
    dueDate: "2026-07-08",
...
export const projectMilestonesSeed = [
  {
    id: "MS-01",
    projectId: "PRJ-01",
    title: "Phase 1: Installation complete",
    dueDate: "2026-07-15",
    completed: false,
  },
  {
...
export const projectExpensesSeed = [
  ...
  },
  {
    id: "PE-02",
    projectId: "PRJ-02",
    description: "GPS units bulk purchase",
    amount: 3150,
    date: "2026-06-16",
  },
];
