...
export function depreciate(asset) {
  ...
  const monthsElapsed = Math.max(
    0,
    (TODAY.getFullYear() - acquired.getFullYear()) * 12 + (TODAY.getMonth() - acquired.getMonth()),
  );
...
export const financeAssetsSeed = [
  {
    id: "AST-01",
    name: "Toyota Hilux — Delivery Truck",
    category: "Vehicles",
  ...
  {
    id: "AST-05",
    name: "Dar es Salaam Warehouse Building",
    category: "Buildings",
...
export const ordersSeed = [
  ...
  {
    id: "SO-2114",
    customer: "Rugambwa Auto Workshop",
    date: "2026-06-18",
    quotationRef: "—",
    status: "Cancelled",
    owner: "S. Kileo",
