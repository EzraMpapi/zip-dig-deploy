...
export const EXPIRY_STATUS_COLOR = {
  Expired: "#EF4444",
...
export const inventorySeed = [
  {
    sku: "HDW-2201",
    name: "Industrial water heater 50L",
  ...
  {
    sku: "HDW-2202",
    name: "Steel reinforcement bar 12mm (ton)",
  ...
  {
    sku: "HDW-2209",
    name: "Cold storage racking system",
    category: "Storage Equipment",
    warehouse: "WH-DSM",
    qty: 11,
    reorder: 5,
...
export const TRANSFER_STATUS_NEXT = {
  Pending: "In Transit",
...
export const transfersSeed = [
  {
    id: "TRF-01",
    sku: "HDW-2208",
    itemName: "Hydraulic vehicle lift",
    qty: 3,
    fromWarehouse: "WH-ARU",
    toWarehouse: "WH-DSM",
    status: "Completed",
    date: "2026-06-20",
    notes: "Consolidating workshop equipment at HQ",
  },
  {
    id: "TRF-02",
    sku: "HDW-2206",
    itemName: "Backwash basin",
    qty: 5,
    fromWarehouse: "WH-MWZ",
    toWarehouse: "WH-DSM",
    status: "In Transit",
    date: "2026-07-01",
    notes: "Reallocating for Baraka Hotels order",
  },
];
...
export const batchesSeed = [
  {
    id: "BATCH-01",
    sku: "HDW-2203",
    itemName: "Cement 50kg bag",
    batchNumber: "CEM-2026-06-A",
    qty: 400,
    expiryDate: "2026-07-20",
    warehouse: "WH-ARU",
...
export const suppliersSeed = [
  {
    ...
    contactPerson: "Rashid Mbwana",
    email: "sales@tpcc.co.tz",
  ...
  {
    id: "SUP-02",
    name: "Coastal Steel & Hardware Ltd",
    contactPerson: "Anna Kimaro",
    email: "orders@coastalsteel.co.tz",
    phone: "+255 754 990 221",
    category: "Hardware & Fixtures",
    leadTimeDays: 10,
    status: "Active",
  },
  {
    id: "SUP-03",
    name: "Zanzibar Electronics Imports",
    contactPerson: "Salim Haji",
    email: "s.haji@znzelectronics.com",
    phone: "+255 777 402 118",
    category: "Electronics",
    leadTimeDays: 21,
    status: "Active",
  },
  {
    id: "SUP-04",
    name: "Furniture Craft Tanzania",
    contactPerson: "Neema Shirima",
    email: "neema@furniturecraft.tz",
    phone: "+255 712 335 890",
    category: "Furniture",
    leadTimeDays: 14,
    status: "Inactive",
  },
