...
// ---- added: IS_CONFIGURED as a live boolean ----
export let IS_CONFIGURED = isSupabaseConfigured();

// ---- added: auth functions ----
export async function authGetUser() {
  // Get current user from Supabase Auth using the stored access token
  const token =
...
export async function authSignOut() {
  // Sign out: clear local token (Supabase has no dedicated logout endpoint)
