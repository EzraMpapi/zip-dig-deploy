    ...
    <div className="p-5 space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="space-y-3">
          ...
          <div>
            <label className="text-[11.5px] font-semibold text-slate-600 block mb-1">
            ...
            <input
              ...
              placeholder="e.g. Baraka Hotels & Resorts"
            />
          </div>
          ...
          {templateId === "loyalty" && (
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                >
                  {["Platinum", "Gold", "Silver", "Bronze", "Member"].map((t) => (
          ...
          <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wide pt-2">
            Signatory
          </p>
          <div className="grid grid-cols-2 gap-2">
            <div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <button
                onClick={() => {
                  setEditing(!editing);
                  if (!editing && !customBody) setCustomBody(template.body);
                }}
            ...
            <p className="text-[10.5px] text-slate-400 mt-1">
              Variables: <code>{"{company}"}</code> <code>{"{recipient}"}</code>{" "}
              <code>{"{tier}"}</code> <code>{"{discount}"}</code>
            </p>
          </div>
        ...
        <div>
          ...
          >
            ...
            <div
              style={{
                height: 5,
                background: `linear-gradient(90deg,${template.accent},${template.accent}66)`,
              }}
            />
            {/* Mini letterhead */}
            <div
            ...
            <div
              style={{
                ...
                borderBottom: `1px solid ${template.accent}20`,
              }}
            >
            ...
            <div style={{ padding: "10px 18px", maxHeight: 220, overflow: "hidden" }}>
              <div style={{ fontSize: 11, fontWeight: 700, color: "#111827", marginBottom: 2 }}>
                {recipient || "Valued Partner"}
              </div>
              {recipientTitle && (
                <div style={{ fontSize: 10, color: "#6B7280" }}>{recipientTitle}</div>
              )}
              {recipientOrg && (
              ...
              <div style={{ fontSize: 11, fontWeight: 600, color: "#111827", margin: "8px 0 6px" }}>
                Dear {recipient || "Valued Partner"},
              </div>
              <div
                style={{
                  fontSize: 10.5,
            ...
            <div style={{ padding: "8px 18px 12px", borderTop: "1px solid #F3F4F6" }}>
              ...
              <div
                style={{
                  ...
                  fontWeight: 800,
                  color: template.accent,
                  borderBottom: `1.5px solid ${template.accent}`,
              ...
              <div style={{ fontSize: 10, fontWeight: 700, color: template.accent }}>
                {company?.name || "SMART MANAGER"}
              </div>
            </div>
            {/* Footer */}
            ...
            >
              ...
              <div style={{ fontSize: 9, fontStyle: "italic", color: "rgba(255,255,255,.3)" }}>
                {template.footer}
              </div>
            </div>
          </div>
          <p className="text-[10.5px] text-slate-400 mt-2 text-center">
            Preview · Full A4 letter prints with all details
          </p>
        </div>
      </div>
    </div>
      ...
      >
        ...
        {(fields.website || fields.email) && (
          <div style={{ marginTop: px(10), position: "relative", textAlign: "center" }}>
            {fields.website && (
              <div style={{ fontSize: px(9), color: c.accent, fontWeight: 600 }}>
                {fields.website}
              </div>
            )}
    ...
    >
      ...
      <div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: px(10), marginBottom: px(14) }}>
          ...
          <div style={{ fontSize: px(13), fontWeight: 800, color: c.text, letterSpacing: -0.3 }}>
        ...
        {fields.dept && (
          <div style={{ fontSize: px(9.5), color: c.sub, marginTop: px(1) }}>{fields.dept}</div>
        )}
      </div>
...
export function BusinessCardDesigner({ company }) {
  ...
  function printCards() {
    ...
    const W = 340,
      H = 214; // 85×54mm at 4px/mm

    function renderFront(f, th) {
      const c = th.front;
      const contacts = [
        f.phone &&
          `<div style="display:flex;align-items:center;gap:5px"><span style="font-size:9px;opacity:.7">📞</span><span style="font-size:9px;color:${c.sub}">${f.phone}</span></div>`,
        f.mobile &&
          `<div style="display:flex;align-items:center;gap:5px"><span style="font-size:9px;opacity:.7">📱</span><span style="font-size:9px;color:${c.sub}">${f.mobile}</span></div>`,
        f.email &&
          `<div style="display:flex;align-items:center;gap:5px"><span style="font-size:9px;opacity:.7">✉</span><span style="font-size:9px;color:${c.sub}">${f.email}</span></div>`,
        f.website &&
          `<div style="display:flex;align-items:center;gap:5px"><span style="font-size:9px;opacity:.7">🌐</span><span style="font-size:9px;color:${c.sub}">${f.website}</span></div>`,
        f.address &&
          `<div style="display:flex;align-items:center;gap:5px"><span style="font-size:9px;opacity:.7">📍</span><span style="font-size:9px;color:${c.sub}">${f.address}</span></div>`,
        f.linkedin &&
          `<div style="display:flex;align-items:center;gap:5px"><span style="font-size:9px;font-weight:700;color:${c.accent}">in</span><span style="font-size:9px;color:${c.sub}">${f.linkedin}</span></div>`,
      ]
        .filter(Boolean)
        .slice(0, 6);
  ...
  function addTeamCard() {
    setTeamCards((t) => [...t, { ...fields, name: "", title: "", dept: "" }]);
  }
  function updateTeamCard(i, k, v) {
    setTeamCards((t) => t.map((c, idx) => (idx === i ? { ...c, [k]: v } : c)));
  }
        ...
        <div className="flex flex-wrap gap-2">
          {CARD_THEMES.map((t) => (
            <button
              ...
              style={
                themeId === t.id ? { background: t.front.bg, borderColor: t.front.accent } : {}
              }
            >
              <span
                className="w-3 h-3 rounded-full inline-block mr-2 align-middle"
                style={{ background: t.front.accent }}
              />
              {t.label}
            </button>
          ))}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
        ...
        <div>
          {!teamMode ? (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                {FIELDS.map(([key, label, ph, type]) => (
                  <div
                    key={key}
                    className={key === "name" || key === "tagline" ? "col-span-2" : ""}
                  >
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wide">
                  Team Cards ({teamCards.length})
                </p>
                <button
                  onClick={addTeamCard}
                  className="text-[11.5px] font-bold text-[#16A34A] border border-[#16A34A]/30 px-2.5 py-1.5 rounded-lg"
                >
                  + Add Person
                </button>
              </div>
                ...
                {teamCards.map((tc, i) => (
                  <div key={i} className="border border-slate-200 rounded-xl p-3 space-y-2">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      {teamCards.length > 1 && (
                        <button
                          onClick={() => setTeamCards((t) => t.filter((_, idx) => idx !== i))}
                          className="text-slate-400 hover:text-[#EF4444] text-[11px]"
                        >
                          Remove
                        </button>
                      )}
                      ...
                      {[
                        ...
                        <div key={k}>
                          ...
                          <input
                            className={inputClass}
                            value={tc[k] || ""}
                            onChange={(e) => updateTeamCard(i, k, e.target.value)}
                            placeholder={fields[k]}
                          />
                        </div>
                      ))}
                    </div>
          ...
          >
            ...
            {teamMode && teamCards.length > 1 ? teamCards.length + " Cards" : "Business Card"}
          </button>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            {(viewSide === "front" || viewSide === "both") && (
              <div>
                <p className="text-[10.5px] text-slate-400 mb-2 uppercase tracking-wide font-semibold">
                  Front Side
                </p>
                <div
                  style={{
          ...
          <p className="text-[10.5px] text-slate-400 mt-3">
            Standard 85×54mm · Print on 300gsm card stock for best results
          </p>
        </div>
      </div>
    </div>
...
export function SettingsPage({
  ...
  async function saveProfile() {
    ...
    try {
      localStorage.setItem("bs_company_profile", JSON.stringify(draft));
    } catch (_e) {}
      ...
      try {
        await sb("companies")
          ...
          .update({
            ...
            business_scale: draft.businessScale,
            receipt_width: draft.receiptWidth,
            receipt_footer: draft.receiptFooter,
            receipt_show_logo: draft.receiptShowLogo,
          })
          .run();
      } catch (e) {
    ...
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-[13px] text-slate-500 mt-1">
          Company profile, module entitlements, and connection status
        </p>
      </div>
      ...
      <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
        ...
        <p className="text-[12.5px] text-slate-500 mb-4">
          Demo only — there&apos;s no login yet, so this stands in for the role a real signed-in
          user would have. Switching it genuinely changes which modules appear in the sidebar and
        ...
        {[
          ...
          return (
            <div key={cat} className="mb-3.5 last:mb-0">
              <p className="text-[10.5px] font-medium text-slate-400 uppercase tracking-wide mb-1.5">
                {cat}
              </p>
        ...
        <div className="mt-4 pt-4 border-t border-slate-100">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <span
              className={`text-[10.5px] font-medium px-2 py-0.5 rounded-full ${canManage ? "bg-[#16A34A]/10 text-[#16A34A]" : "bg-slate-100 text-slate-500"}`}
            >
              {canManage ? "Full write access" : "Read-only"}
            </span>
            <span className="text-[10.5px] text-slate-400">
              {currentRole.allowedModules.length} of {MODULES.length} modules visible
            </span>
            {currentRole.primaryModules.length > 0 &&
              currentRole.primaryModules.length < currentRole.allowedModules.length && (
                <span className="text-[10.5px] text-slate-400">
                  · primary work in {currentRole.primaryModules.length}
                </span>
              )}
          </div>
          {currentRole.primaryModules.length > 0 &&
            currentRole.primaryModules.length < currentRole.allowedModules.length && (
              <p className="text-[11px] text-slate-400 mt-2 leading-relaxed">
                Company-wide visibility, department-scoped ownership — real enterprise practice:
                broad oversight, focused accountability. Honest limitation: this build&apos;s write
                permission is still one global switch per role (section 29), not a per-module lock —
                a Finance Manager technically *could* edit HR after navigating there, the same
                declared scope boundary as every other permission check in this system. Primary
                modules describe intended ownership, not yet an enforced wall around it.
              </p>
            )}
        </div>
      </section>
        ...
        <>
          ...
          <section className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
            ...
            <div className="relative">
              <div
                className="h-36 sm:h-44 w-full overflow-hidden bg-gradient-to-br from-[#0D2214] to-[#16A34A] relative group cursor-pointer"
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (file.size > 5 * 1024 * 1024) {
                    notify("Cover photo must be under 5 MB.", "error");
                    return;
                  }
              ...
              <div className="absolute -bottom-10 left-5 flex items-end gap-3">
                <div
                  className="w-20 h-20 rounded-2xl border-4 border-white bg-white shadow-lg overflow-hidden flex items-center justify-center cursor-pointer group relative"
                ...
                >
                  {draft.logo ? (
                    ...
                    <div className="text-center p-1">
                      <div
                        className="w-10 h-10 rounded-xl flex items-center justify-center mx-auto text-[22px] font-black text-white"
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (file.size > 2 * 1024 * 1024) {
                      notify("Logo must be under 2 MB.", "error");
                      return;
                    }
                    const reader = new FileReader();
            ...
            {(() => {
              ...
              return (
                <div className="mt-12 px-5 pt-2 pb-3 border-b border-slate-100">
                  ...
                  {pct < 100 && (
                    <p className="text-[10.5px] text-slate-400 mt-1">
                      {!draft.coverPhoto && "· Cover photo "}
                      {!draft.description && "· Description "}
                      {!draft.bankName && "· Bank details "}still missing
                    </p>
                  )}
                </div>
              );
                ...
                <div>
                  ...
                  <div className="p-5 space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="sm:col-span-2">
                            <FormField label="Company Name" required>
                              <input
                                ...
                                placeholder="e.g. BEIRAHISI HARDWARE Ltd"
                              />
                            </FormField>
                          </div>
                          <div className="sm:col-span-2">
                            <FormField label="Tagline">
                              <input
                                ...
                                placeholder="e.g. Building East Africa's Future"
                              />
                            </FormField>
                          </div>
                          <div className="sm:col-span-2">
                          ...
                          <FormField label="Industry / Sector">
                            <input
                              ...
                              placeholder="e.g. Wholesale & Hardware"
                            />
                          </FormField>
                          <FormField label="Business Type">
                            <select
                              className={inputClass}
                              value={draft.businessType || "Private Limited Company"}
                          ...
                          <FormField label="Business Scale">
                            <select
                              ...
                              onChange={(e) => setField("businessScale", e.target.value)}
                            >
                          ...
                          <FormField label="TIN Number">
                            ...
                            />
                            <p className="text-[10.5px] text-slate-400 mt-1">
                              Printed on invoices and TRA tax documents
                            </p>
                          </FormField>
                          <FormField label="Business Registration No.">
                            <input
                              ...
                              placeholder="e.g. BRELA 12345678"
                            />
                          </FormField>
                          ...
                          <FormField label="Base Currency">
                            ...
                            >
                              {["TZS", "KES", "UGX", "USD", "EUR", "GBP", "ZAR", "NGN"].map(
                                (curr) => (
                          ...
                          <FormField label="Tax Rate (%)">
                            ...
                            />
                            <p className="text-[10.5px] text-slate-400 mt-1">
                              Applied to all invoices, POS sales, and VAT calculations
                            </p>
                          </FormField>
                      ...
                      <div className="space-y-5">
                        ...
                        <div>
                          ...
                          <div className="flex items-start gap-4">
                            <div
                              className="w-24 h-24 rounded-2xl border-2 border-dashed border-slate-200 flex items-center justify-center overflow-hidden bg-slate-50 relative group cursor-pointer shrink-0"
                            ...
                            <div className="flex-1 space-y-2">
                              <p className="text-[12.5px] text-slate-600">
                                Your logo appears on all documents, receipts, payslips, PDF exports,
                                and the app header.
                              </p>
                              <p className="text-[11px] text-slate-400">
                                PNG, JPG, SVG, WebP · max 2 MB · Transparent background recommended
                              </p>
                              {draft.logo && (
                                <button
                        ...
                        <div>
                          ...
                          <div
                            className="rounded-xl overflow-hidden border-2 border-dashed border-slate-200 bg-slate-50 relative group cursor-pointer"
                            style={{ height: "140px" }}
                            onClick={() => document.getElementById("cover-upload-b").click()}
                          >
                            {draft.coverPhoto ? (
                              <img
                              ...
                              <div className="absolute inset-0 flex flex-col items-center justify-center gap-1">
                                ...
                                <p className="text-[10.5px] text-slate-400">
                                  Recommended: 1200 × 400 px · PNG, JPG, WebP · max 5 MB
                                </p>
                              </div>
                            )}
                            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/15 transition-all flex items-center justify-center">
                              <div className="opacity-0 group-hover:opacity-100 bg-black/50 text-white text-[11.5px] font-semibold px-3 py-1.5 rounded-lg flex items-center gap-1.5">
                                <Upload size={12} />
                                {draft.coverPhoto ? "Change Cover Photo" : "Upload Cover Photo"}
                              </div>
                            </div>
                          </div>
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              if (!file) return;
                              if (file.size > 5 * 1024 * 1024) {
                                notify("Cover must be under 5 MB.", "error");
                                return;
                              }
                              const reader = new FileReader();
                              reader.onload = (ev) => setField("coverPhoto", ev.target.result);
                          ...
                          {draft.coverPhoto && (
                            <button
                              onClick={() => setField("coverPhoto", null)}
                              className="mt-1.5 text-[11px] text-[#EF4444] hover:underline"
                            >
                              Remove cover photo
                            </button>
                          )}
                        ...
                        <div>
                          ...
                          <p className="text-[12px] text-slate-500 mb-3">
                            Used as the accent colour on PDF reports, company card, and exported
                            documents.
                          </p>
                          <div className="flex items-center gap-3 flex-wrap">
                            {[
                              ...
                              <button
                                key={col}
                                onClick={() => setField("brandColor", col)}
                          ...
                          <div className="mt-3 rounded-xl overflow-hidden border border-slate-200">
                            ...
                            <div className="flex items-center gap-3 p-3 bg-[#0D2214]">
                              <div
                                className="w-8 h-8 rounded-lg flex items-center justify-center text-white text-[13px] font-black"
                                style={{ background: draft.brandColor || "#16A34A" }}
                              >
                                {(draft.name || "C").charAt(0).toUpperCase()}
                              </div>
                              ...
                              <span
                                className="text-[10.5px] font-bold ml-auto px-2.5 py-0.5 rounded-full text-white"
                                style={{ background: draft.brandColor || "#16A34A" }}
                              >
                                Preview
                              </span>
                        ...
                        {/* Receipt settings */}
                        <div>
                          <p className="text-[12.5px] font-bold text-[#111827] mb-3">
                            Receipt Settings
                          </p>
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            <FormField label="Show Logo on Receipt">
                              <select
                                className={inputClass}
                                value={String(draft.receiptShowLogo)}
                                onChange={(e) =>
                                  setField("receiptShowLogo", e.target.value === "true")
                                }
                              >
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <FormField label="WhatsApp Business Number">
                            ...
                            />
                            <p className="text-[10.5px] text-slate-400 mt-1">
                              Shown as wa.me/ link on receipts and quotations
                            </p>
                          </FormField>
                          <div className="sm:col-span-2">
                            <FormField label="Street Address">
                              <input
                                ...
                                placeholder="e.g. Plot 45, Kariakoo, Mnazi Mmoja"
                              />
                            </FormField>
                          </div>
                        ...
                        <div className="mt-2 bg-slate-50 rounded-xl p-4 border border-slate-200">
                          <p className="text-[10.5px] font-bold text-slate-400 uppercase tracking-wide mb-2">
                            Contact block preview (as shown on documents)
                          </p>
                          <div className="space-y-1">
                            {draft.address && (
                              <p className="text-[12px] text-slate-600">
                                📍{" "}
                                {[draft.address, draft.city, draft.postalCode]
                                  .filter(Boolean)
                                  .join(", ")}
                              </p>
                            )}
                            {draft.phone && (
                              <p className="text-[12px] text-slate-600">📞 {draft.phone}</p>
                            )}
                            {draft.email && (
                              <p className="text-[12px] text-slate-600">✉️ {draft.email}</p>
                            )}
                            {draft.website && (
                              <p className="text-[12px] text-[#2563EB]">🌐 {draft.website}</p>
                            )}
                            {!draft.address && !draft.phone && !draft.email && (
                              <p className="text-[12px] text-slate-400 italic">
                                Fill in your contact details above to see the preview
                              </p>
                            )}
                          </div>
                        </div>
                      ...
                      <div className="space-y-4">
                        <div className="bg-[#EFF6FF] border border-[#BFDBFE] rounded-xl p-3 flex items-start gap-2.5">
                          ...
                          <p className="text-[12px] text-[#1D4ED8]">
                            Bank details appear on invoices, quotations, and payment requests —
                            making it easy for clients to pay via bank transfer.
                          </p>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <FormField label="SWIFT / BIC Code">
                            <input
                              ...
                              onChange={(e) => setField("bankSwift", e.target.value)}
                              placeholder="e.g. CRBDTZTZ (for international transfers)"
                            />
                          </FormField>
                          <FormField label="Currency">
                            <select
                              ...
                              onChange={(e) => setField("currency", e.target.value)}
                            >
                              {["TZS", "KES", "UGX", "USD", "EUR", "GBP"].map((curr) => (
                                <option key={curr}>{curr}</option>
                              ))}
                            </select>
                          </FormField>
                        ...
                        {draft.bankName && (
                          <div className="bg-slate-50 rounded-xl p-4 border border-slate-200">
                            <p className="text-[10.5px] font-bold text-slate-400 uppercase tracking-wide mb-2">
                              Bank details block (as printed on invoices)
                            </p>
                            <div className="space-y-1 text-[12.5px] text-slate-700">
                              <p>
                                <strong>Bank:</strong> {draft.bankName}
                              </p>
                              {draft.bankAccountName && (
                                <p>
                                  <strong>Account Name:</strong> {draft.bankAccountName}
                                </p>
                              )}
                              {draft.bankAccountNo && (
                                <p>
                                  <strong>Account No:</strong>{" "}
                                  <span className="font-mono">{draft.bankAccountNo}</span>
                                </p>
                              )}
                              {draft.bankBranch && (
                                <p>
                                  <strong>Branch:</strong> {draft.bankBranch}
                                </p>
                              )}
                              {draft.bankSwift && (
                                <p>
                                  <strong>SWIFT:</strong>{" "}
                                  <span className="font-mono">{draft.bankSwift}</span>
                                </p>
                              )}
                            </div>
                          </div>
                    ...
                    {profileTab === "hours" && (
                      <div className="space-y-3">
                        <p className="text-[12.5px] text-slate-500">
                          Shown on your company profile card and used by the Employee Portal for
                          attendance status.
                        </p>
                        {Object.entries(draft.businessHours || {}).map(([day, hrs]) => (
                          <div key={day} className="flex items-center gap-3">
                            <span className="w-10 text-[12.5px] font-bold text-slate-700 shrink-0">
                              {day}
                            </span>
                            ...
                            {!hrs.closed && (
                              <>
                                <input
                                  type="time"
                                  className="text-[12px] border border-slate-200 rounded-lg px-2 py-1.5 outline-none focus:border-[#16A34A] bg-white"
                                  value={hrs.open || "08:00"}
                                  onChange={(e) =>
                                    setField("businessHours", {
                                      ...draft.businessHours,
                            ...
                            {hrs.closed && (
                              <span className="text-[12px] text-slate-400 italic ml-2">
                                Closed all day
                              </span>
                            )}
                          </div>
                    ...
                    {profileTab === "social" && (
                      <div className="space-y-4">
                        <p className="text-[12.5px] text-slate-500">
                          Social links appear on your company profile card, email footers, and
                          printed documents.
                        </p>
                        <div className="space-y-3">
                          {[
                            ...
                            <div key={key} className="flex items-center gap-3">
                              <div
                                className="w-8 h-8 rounded-lg flex items-center justify-center text-white text-[12px] font-black shrink-0"
                              ...
                              <div className="flex-1 flex items-center border border-slate-200 rounded-lg overflow-hidden focus-within:border-[#16A34A] focus-within:ring-1 focus-within:ring-[#16A34A]/30">
                                <span className="text-[11px] text-slate-400 px-2 bg-slate-50 border-r border-slate-200 whitespace-nowrap py-2">
                                  {prefix}
                                </span>
                                <input
                                  className="flex-1 text-[12.5px] px-3 py-2 outline-none bg-white"
                                  value={draft[key] || ""}
                        ...
                        {(draft.facebook || draft.instagram || draft.twitter || draft.linkedin) && (
                          <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
                            <p className="text-[10.5px] font-bold text-slate-400 uppercase tracking-wide mb-2">
                              Social links (document footer)
                            </p>
                            <div className="flex gap-3 flex-wrap">
                              {draft.facebook && (
                                <a
                                  href={"https://facebook.com/" + draft.facebook}
                                  target="_blank"
                                  rel="noopener"
                                  className="text-[#1877F2] text-[12px] font-semibold"
                                >
                                  f/ {draft.facebook}
                                </a>
                              )}
                              {draft.instagram && (
                                <a
                                  href={"https://instagram.com/" + draft.instagram}
                                  target="_blank"
                                  rel="noopener"
                                  className="text-[#E1306C] text-[12px] font-semibold"
                                >
                                  @ {draft.instagram}
                                </a>
                              )}
                              {draft.twitter && (
                                <a
                                  href={"https://x.com/" + draft.twitter}
                                  target="_blank"
                                  rel="noopener"
                                  className="text-[#000000] text-[12px] font-semibold"
                                >
                                  𝕏/ {draft.twitter}
                                </a>
                              )}
                              {draft.linkedin && (
                                <a
                                  href={"https://linkedin.com/company/" + draft.linkedin}
                                  target="_blank"
                                  rel="noopener"
                                  className="text-[#0A66C2] text-[12px] font-semibold"
                                >
                                  in/ {draft.linkedin}
                                </a>
                              )}
          ...
          <section className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b border-slate-100">
              ...
              <p className="text-[12px] text-slate-400 mt-0.5">
                Live preview — how your company appears on documents, receipts, and exports
              </p>
            </div>
            <div className="relative">
              {/* Cover photo */}
              <div
                ...
                style={{
                  background: draft.coverPhoto
                    ? "none"
                    : `linear-gradient(135deg,${draft.brandColor || "#16A34A"}22 0%,${draft.brandColor || "#16A34A"}44 100%)`,
                }}
              >
                {draft.coverPhoto && (
                  <img src={draft.coverPhoto} alt="Cover" className="w-full h-full object-cover" />
              ...
              <div className="absolute left-5 bottom-0 translate-y-1/2">
                <div
                  className="w-16 h-16 rounded-2xl border-4 border-white bg-white shadow-md overflow-hidden flex items-center justify-center"
            ...
            <div className="pt-12 px-5 pb-5">
              <div className="flex items-start justify-between gap-3 flex-wrap">
                <div>
                  <h3 className="text-[17px] font-black text-[#111827]">
                    {draft.name || "Your Company Name"}
                  </h3>
                  {draft.tagline && (
                    <p className="text-[12.5px] text-slate-500 italic mt-0.5">{draft.tagline}</p>
                  )}
                ...
                <div className="flex flex-col items-end gap-1">
                  {draft.tin && (
                    <span className="text-[10.5px] font-mono text-slate-400">TIN: {draft.tin}</span>
                  )}
                  {draft.regNumber && (
              ...
              {draft.description && (
                <p className="text-[12.5px] text-slate-600 mt-3 leading-relaxed">
                  {draft.description}
                </p>
              )}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 mt-4 text-[12px] text-slate-600">
                {draft.address && (
                  <span className="flex items-center gap-1.5">
                    ...
                    {[draft.address, draft.city, draft.postalCode, draft.country]
                      .filter(Boolean)
                      .join(", ")}
                  </span>
                )}
                  ...
                  {[
                    ...
                    .map((s) => (
                      <a
                        key={s.k}
                        href={"#"}
                        className="w-8 h-8 rounded-full flex items-center justify-center text-white text-[12px] font-black hover:opacity-80 transition-opacity"
                ...
                <div className="mt-4 pt-4 border-t border-slate-100">
                  ...
                  <div className="bg-slate-50 rounded-xl p-3 grid grid-cols-2 gap-x-4 gap-y-1 text-[12px]">
                    <div>
                      ...
                      <p className="font-semibold text-[#111827]">{draft.bankName}</p>
                    </div>
                    {draft.bankAccountName && (
                      <div>
                        <span className="text-slate-400">Account Name</span>
                        <p className="font-semibold">{draft.bankAccountName}</p>
                      </div>
                    )}
                    {draft.bankAccountNo && (
                      <div>
                        <span className="text-slate-400">Account No.</span>
                        <p className="font-mono font-bold">{draft.bankAccountNo}</p>
                      </div>
                    )}
                    {draft.bankBranch && (
                      <div>
                        <span className="text-slate-400">Branch</span>
                        <p className="font-semibold">{draft.bankBranch}</p>
                      </div>
                    )}
                    {draft.bankSwift && (
                      <div>
                        <span className="text-slate-400">SWIFT</span>
                        <p className="font-mono">{draft.bankSwift}</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {/* Business hours */}
              {draft.businessHours &&
                Object.values(draft.businessHours || {}).some((h) => !h.closed) && (
                  <div className="mt-4 pt-4 border-t border-slate-100">
                    <p className="text-[10.5px] font-bold text-slate-400 uppercase tracking-wide mb-2">
                      Business Hours
                    </p>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 text-[11.5px]">
                      {Object.entries(draft.businessHours || {}).map(([day, hrs]) => (
                        <div
                          key={day}
                          className={`flex items-center justify-between px-2.5 py-1.5 rounded-lg ${hrs.closed ? "bg-slate-50 text-slate-300" : "bg-[#F0FDF4] text-[#166534]"}`}
                        >
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(90deg,${draft.brandColor || "#16A34A"},${draft.brandColor || "#16A34A"}88)`,
                }}
              />
            </div>
          </section>
          ...
          <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[12.5px] text-slate-500 mt-1">
                  Real, not cosmetic — but honestly scoped to the sidebar and top navigation only.
                  Rewriting every module&apos;s colors across this entire application would risk a
                  half-correct result, some screens right and others silently broken, which would be
                  worse than not having this at all. Module content stays light-themed for now.
                </p>
              </div>
              <ToggleSwitch
                on={darkMode}
            ...
            <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100">
              <div>
                ...
                <p className="text-[11px] text-slate-400">
                  Scales every screen — WCAG 1.4.4 resize, done at the root, not a fake zoom.
                </p>
              </div>
              <div className="flex items-center gap-1 bg-slate-100 rounded-lg p-1">
                {[
                  ...
                  <button
                    key={v}
                    onClick={() => onSetTextSize(v)}
                    className={`text-[11.5px] font-medium px-2.5 py-1.5 rounded-md ${textSize === v ? "bg-white text-[#111827] shadow-sm" : "text-slate-500"}`}
                  >
                    {l}
                  </button>
                ))}
            ...
            <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100">
              <div>
                ...
                <p className="text-[11px] text-slate-400">
                  Darker text, stronger borders, everywhere — one real class, all 22 modules.
                </p>
              </div>
              <ToggleSwitch
                on={highContrast}
          ...
          <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
            ...
            <p className="text-[12.5px] text-slate-500 mb-5">
              Enable only what your business needs — disabled modules disappear from the sidebar.
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11.5px] text-slate-400">
                          {isCore
                            ...
                            : m.live
                              ? "Available"
                              : "Coming soon — can be pre-enabled"}
                        </p>
                      </div>
                    </div>
                    <ToggleSwitch
                      ...
                      label={`${on ? "Disable" : "Enable"} ${m.label} module`}
                    />
                  </div>
                );
              })}
      ...
      <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
        ...
        <p className="text-[12.5px] text-slate-500 mb-4">
          Where this workspace reads and writes its data.
        </p>

        <div
          className="flex items-start gap-3 rounded-lg p-4"
          style={{
            backgroundColor: IS_CONFIGURED ? "#16A34A0D" : "#F59E0B0D",
            border: `1px solid ${IS_CONFIGURED ? "#16A34A33" : "#F59E0B33"}`,
          }}
        >
          <span
            className="w-2 h-2 rounded-full mt-1.5 shrink-0"
            style={{ backgroundColor: IS_CONFIGURED ? "#16A34A" : "#F59E0B" }}
          />
            ...
            {IS_CONFIGURED ? (
              <p className="text-[#111827]">
                ...
                <span className="text-slate-600">
                  All reads and writes go to your live project, scoped to your company by row-level
                  security.
                </span>
              </p>
            ) : (
              <p className="text-[#111827]">
                ...
                <span className="text-slate-600">
                  You're working with built-in sample data — changes live only in this session. To
                  go live: run{" "}
                  <span className="font-mono text-[11.5px] bg-slate-100 px-1 py-0.5 rounded">
                    businesssphere-schema.sql
                  </span>{" "}
                  ...
                  at the top of the app file, then sign up — Signup creates your company and your
                  account together, no manual database step needed.
                </span>
              </p>
            )}
          </div>
      ...
      <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
        ...
        <p className="text-[12.5px] text-slate-500 mb-4">
          Manage user accounts and access levels for your organisation
        </p>
      ...
      <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm overflow-hidden">
        <div className="px-5 pt-5 pb-3">
          ...
          <p className="text-[12.5px] text-slate-500">
            Design and print professional congratulations letters for your top customers, partners,
            and staff.
          </p>
        </div>
  ...
  const TEAM_SEED = [
    {
      id: "USR-001",
      name: "EzyMP",
      email: "admin@businesssphere.co.tz",
    ...
    },
    {
      id: "USR-002",
      name: "Grace Mwangi",
      email: "grace@businesssphere.co.tz",
    ...
    },
    {
      id: "USR-003",
      name: "John Ochieng",
      email: "john@businesssphere.co.tz",
      role: "HR Manager",
      status: "Active",
      lastSeen: "1 day ago",
      avatar: "J",
    },
    {
      id: "USR-004",
      name: "Amina Hassan",
      email: "amina@businesssphere.co.tz",
    ...
    },
    {
      id: "USR-005",
      name: "Peter Kamau",
      email: "peter@businesssphere.co.tz",
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex gap-2 text-[12px] font-medium text-slate-500">
          <span className="bg-green-50 text-green-700 px-2.5 py-0.5 rounded-full font-semibold">
        ...
        {canManage && (
          <button
            ...
            className="flex items-center gap-1.5 text-[12.5px] font-semibold text-white px-4 py-2 rounded-xl bg-[#16A34A]"
          >
            <UserPlus size={13} />
            Invite Member
          </button>
      ...
      {showInvite && (
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <FormField label="Email *">
              <input
                ...
                placeholder="email@company.co.tz"
              />
            </FormField>
          ...
          <div className="flex gap-2">
            <button
              onClick={sendInvite}
              className="text-[12.5px] font-semibold text-white px-5 py-2.5 rounded-xl bg-[#16A34A]"
            >
              Send Invite
            </button>
            <button
            ...
            <div key={m.id} className="flex items-center gap-3 py-3.5">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {m.id === "USR-001" && (
                    <span className="text-[9.5px] font-bold bg-[#7C3AED] text-white px-1.5 py-0.5 rounded-full">
                      YOU
                    </span>
                  )}
                  <span
                    className="text-[10px] font-semibold px-2 py-0.5 rounded-full"
                    style={{ background: statusStyle[0], color: statusStyle[1] }}
                  >
                    {m.status}
                  </span>
                </div>
                <p className="text-[11.5px] text-slate-400 mt-0.5">
                  {m.email} · Last seen: {m.lastSeen}
                </p>
              </div>
                ...
                {canManage && m.id !== "USR-001" && (
                  <button
                    onClick={() => {
                      ...
                      notify(m.name + " " + (m.status === "Active" ? "deactivated" : "activated"));
                    }}
                    className="text-[11px] text-slate-400 hover:text-slate-600 px-2 py-1 rounded-lg border border-slate-200 hover:border-slate-300"
                  >
...
export function AuditLogViewer({ timezone }) {
  ...
  const modules = useMemo(
    () => ["all", ...Array.from(new Set(entries.map((e) => e.module)))],
    [entries],
  );
    ...
    <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
      <div className="flex items-center justify-between mb-1 gap-3">
        ...
        <select
          ...
          className="text-[12px] border border-slate-200 rounded-lg px-2 py-1.5 outline-none"
        >
          {modules.map((m) => (
      ...
      <p className="text-[12.5px] text-slate-500 mb-4">
        A real, running record of significant actions across the system — new entries are captured
        live as they happen, right now, in this session.{" "}
        {IS_CONFIGURED
          ? "Loads real historical entries from the server on open."
          : "Demo mode has no backend log storage, so history doesn't persist across a page reload."}{" "}
        Actor reflects whichever demo role is selected above, not a verified identity — see the
        handover doc.
      </p>
      {loading ? (
        <SkeletonRows cols={1} />
        ...
        <div className="text-center py-8">
          ...
          <p className="text-[12.5px] text-slate-400">
            No actions logged yet. Approve a leave request, record a payment, or adjust stock via
            the AI Assistant to see one appear here.
          </p>
        </div>
      ) : (
        <div className="space-y-0.5 max-h-[360px] overflow-y-auto">
          {filtered.map((e) => (
            <div
              key={e.id}
              className="flex items-start gap-2.5 px-2 py-2 border-b border-slate-50 last:border-0"
            >
              ...
              <span className="text-[10.5px] text-slate-400 shrink-0 font-mono">
                {formatInTimezone(e.timestamp, timezone, { hour: "2-digit", minute: "2-digit" })}
              </span>
            </div>
          ))}
        </div>
...
export function BranchesManager() {
  const branches = useCompanyTable(
    "branches",
    [
      {
        id: "BR-01",
  ...
  async function addBranch(e) {
    ...
    if (IS_CONFIGURED) {
      try {
        const header = await sb("branches")
          .insert({ name: draft.name, address: draft.address, city: draft.city })
          .single()
          .run();
        if (header?.id)
          branches.setRows((prev) =>
            prev.map((b) => (b.id === draft.id ? { ...b, dbId: header.id } : b)),
          );
      } catch (_e) {
        notify("Branch added locally, but saving to the server failed.", "error");
      }
    }
  }
  ...
  async function deleteBranch(id) {
    ...
    if (b?.isHeadquarters) {
      notify("The headquarters branch can't be removed.", "error");
      return;
    }
    branches.setRows((prev) => prev.filter((x) => x.id !== id));
    if (IS_CONFIGURED && b?.dbId) {
      try {
        await sb("branches").eq("id", b.dbId).delete().run();
      } catch (_e) {
        notify("Couldn't delete the branch on the server.", "error");
      }
    }
  }
  ...
  return (
    <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
      ...
      <p className="text-[12.5px] text-slate-500 mb-4">
        A real registry of your company&apos;s physical locations. Honest scope: only POS
        transactions currently record which branch a sale happened at (a real, working column) —
        Sales, HR, and Finance don&apos;t yet filter or report by branch. Extending that everywhere
        is a genuine, larger follow-up, not done here.
      </p>
      {showForm && (
        <form
          onSubmit={addBranch}
          className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-4 bg-slate-50 rounded-lg p-3"
        >
          <input
            className={inputClass}
            value={form.name}
          ...
          <div className="flex gap-2">
            ...
            <button
              type="submit"
              className="btn-primary text-white text-[12px] font-medium px-3 rounded-lg shrink-0"
            >
              Add
            </button>
          </div>
        ...
        {branches.rows.map((b) => (
          <div key={b.id} className="flex items-center justify-between py-2.5">
            <div className="flex items-center gap-2">
              ...
              {b.isHeadquarters && (
                <span className="text-[10px] font-medium text-[#16A34A] bg-[#16A34A]/10 px-1.5 py-0.5 rounded-full">
                  HQ
                </span>
              )}
...
export function DepartmentsManager({ employeesHook }) {
  const departments = useCompanyTable("departments", [], {
    order: { col: "name", ascending: true },
    mapRow: (r) => ({ id: r.id, dbId: r.id, name: r.name }),
  });
  ...
  async function installKit() {
    ...
    const missing = names.filter(
      (n) => !departments.rows.some((d) => d.name.toLowerCase() === n.toLowerCase()),
    );
    if (missing.length === 0) {
      notify(`${kit} departments already exist — nothing to add.`);
      return;
    }
    ...
    notify(
      `${kit} starter kit installed — ${missing.length} department(s) created, existing ones untouched.`,
    );
    if (IS_CONFIGURED) {
      for (const row of rows) {
        try {
          ...
          if (header?.id)
            departments.setRows((prev) =>
              prev.map((d) => (d.id === row.id ? { ...d, dbId: header.id } : d)),
            );
        } catch (_e) {
          notify(`"${row.name}" saved locally, but the server update failed.`, "error");
        }
      }
    }
  }
  const headcount = (name) =>
    employeesHook.rows.filter((e) => (e.department || "").toLowerCase() === name.toLowerCase())
      .length;
  const untracked = [...new Set(employeesHook.rows.map((e) => e.department || "General"))].filter(
    (d) => !departments.rows.some((x) => x.name.toLowerCase() === d.toLowerCase()),
  );
  ...
  return (
    <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
      ...
      <p className="text-[12.5px] text-slate-500 mt-1 mb-4">
        A real managed list — with each department&apos;s real live headcount. Creating one here
        doesn&apos;t rewrite existing free-text values on employees; it gives new records a list to
        converge on.
      </p>
      <form onSubmit={addDept} className="flex gap-2 mb-4 max-w-sm">
        ...
        <button
          type="submit"
          disabled={!draft.trim()}
          className="btn-primary text-white text-[12px] font-medium rounded-lg px-3.5 shrink-0 disabled:opacity-40"
        >
          Add
        </button>
      </form>
      <div className="flex gap-2 mb-4 max-w-md items-center">
        <select className={inputClass} value={kit} onChange={(e) => setKit(e.target.value)}>
          ...
          {Object.keys(INDUSTRY_DEPT_KITS).map((k) => (
            <option key={k} value={k}>
              {k} — {INDUSTRY_DEPT_KITS[k].length} departments
            </option>
          ))}
        </select>
        <button
          onClick={installKit}
          disabled={!kit}
          className="text-[12px] font-medium border border-[#16A34A]/40 text-[#16A34A] rounded-lg px-3.5 py-2 shrink-0 hover:bg-[#16A34A]/5 disabled:opacity-40"
        >
          Install kit
        </button>
      </div>
      <div className="flex flex-wrap gap-2">
        {departments.rows.map((d) => (
          <span
            key={d.id}
            className="text-[12px] font-medium bg-slate-100 text-slate-600 rounded-full px-3 py-1.5"
          >
            {d.name} <span className="text-slate-400">· {headcount(d.name)}</span>
          </span>
        ))}
        {departments.loading && <span className="text-[12px] text-slate-400">Loading...</span>}
        {!departments.loading && departments.rows.length === 0 && (
          <span className="text-[12px] text-slate-400">No departments yet.</span>
        )}
      </div>
      {untracked.length > 0 && (
        <p className="text-[10.5px] text-slate-400 mt-3">
          In use on employees but not in this list: {untracked.join(", ")} — stated rather than
          hidden.
        </p>
      )}
    </section>
...
export function AppLockManager() {
  ...
  useEffect(() => {
    setHasBio(!!window.localStorage.getItem("bs_bio_applock"));
  }, []);
    ...
    try {
      const cred = await navigator.credentials.create({
        publicKey: {
          ...
          user: {
            id: new TextEncoder().encode("app-lock"),
            name: "App Lock",
      ...
      setHasBio(true);
      notify(
        "Biometric unlock enrolled on this device — fingerprint or Face ID, whichever this device has.",
      );
    } catch (_e) {
      notify("Enrollment cancelled or no sensor available on this device.", "error");
    }
  }
  function removeBio() {
    window.localStorage.removeItem("bs_bio_applock");
    setHasBio(false);
    notify("Biometric unlock removed from this device.");
  }
  const [showForm, setShowForm] = useState(false);
    ...
    <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
      <div className="flex items-center justify-between mb-1">
        <div>
          ...
          <p className="text-[12.5px] text-slate-500 mt-1">
            A real PIN gate for this device — genuinely hashed, never stored in plain text. Honest
            limit: this protects a shared device from casual access, not a substitute for your real
            account password.
          </p>
        </div>
        <ToggleSwitch
          on={hasPin}
          onChange={() => (hasPin ? removePin() : setShowForm(true))}
          label={hasPin ? "Turn off App Lock" : "Turn on App Lock"}
        />
      </div>
      {hasPin && (
        <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between">
          <div>
            <p className="text-[12.5px] font-medium text-[#111827] flex items-center gap-1.5">
              <Fingerprint size={13} className="text-[#16A34A]" /> Biometric unlock
            </p>
            <p className="text-[10.5px] text-slate-400 mt-0.5">
              Real fingerprint or Face ID via this device&apos;s own sensor (WebAuthn) — the
              biometric never leaves the device. PIN stays as fallback, same as your phone.
            </p>
          </div>
          {hasBio ? (
            <button
              onClick={removeBio}
              className="text-[11.5px] font-medium text-[#EF4444] border border-[#EF4444]/30 rounded-lg px-3 py-1.5"
            >
              Remove
            </button>
          ) : (
            <button
              onClick={enrollBio}
              className="text-[11.5px] font-medium btn-primary text-white rounded-lg px-3 py-1.5"
            >
              Enroll
            </button>
          )}
      ...
      {showForm && (
        <form onSubmit={savePin} className="mt-4 pt-4 border-t border-slate-100 space-y-3 max-w-xs">
          <FormField label="New PIN (4–6 digits)">
            <input
              type="password"
              inputMode="numeric"
              maxLength={6}
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 text-[12px] font-medium border border-slate-200 rounded-lg py-2"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="flex-1 text-[12px] font-medium btn-primary text-white rounded-lg py-2"
            >
              Save PIN
            </button>
          </div>
...
export function BusinessNetworkSection({ company }) {
  const profiles = useCompanyTable("network_profiles", [], {
    order: { col: "company_name", ascending: true },
    mapRow: (r) => ({
      id: r.id,
      dbId: r.id,
      name: r.company_name,
  ...
  const rfqs = useCompanyTable("network_rfqs", [], {
  ...
  async function publishProfile() {
    ...
    notify(
      "Profile published to the Business Network — visible to every business on the platform, by your choice.",
    );
    if (IS_CONFIGURED) {
      try {
        const header = await sb("network_profiles")
          .insert({
          ...
          .run();
        if (header?.id)
          profiles.setRows((prev) =>
            prev.map((p) => (p.id === row.id ? { ...p, dbId: header.id } : p)),
          );
      } catch (_e) {
        notify("Published locally, but the server update failed.", "error");
      }
    }
  }
  ...
  async function postRfq() {
    ...
    const row = {
      ...
      category: rfqDraft.category,
      qty: rfqDraft.qty,
      deadline: rfqDraft.deadline || null,
      contact: rfqDraft.contact,
    };
    rfqs.setRows((prev) => [row, ...prev]);
    setShowRfqForm(false);
    setRfqDraft({ title: "", category: "", qty: "", deadline: "", contact: "" });
    notify(
      "RFQ published — every business on the network can see it and respond via your contact.",
    );
    if (IS_CONFIGURED) {
      try {
        const header = await sb("network_rfqs")
          .insert({
            company_name: company.name,
            title: row.title,
            category: row.category || null,
            quantity_note: row.qty || null,
  ...
  return (
    <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
      ...
      <p className="text-[12.5px] text-slate-500 mt-1 mb-4">
        The platform&apos;s one deliberate cross-company surface: everything here is public to every
        business, by explicit choice — nothing from your books ever appears here. Verified badges
        are granted only by platform operations against a real TIN; a business cannot verify itself.
        Ratings, partnerships, and secure messaging are named future work.
      </p>

      {!mine && (
        <div className="border border-dashed border-slate-300 rounded-xl p-4 mb-4">
          <p className="text-[12.5px] font-medium text-[#111827] mb-2">
            Publish your business to the directory
          </p>
          <div className="flex gap-2 max-w-lg">
            <input
              ...
              placeholder="What you offer, in one line — e.g. Wholesale building materials, Dar es Salaam"
            />
            <button
              onClick={publishProfile}
              className="btn-primary text-white text-[12px] font-medium rounded-lg px-3.5 shrink-0"
            >
              Publish
            </button>
          </div>
      ...
      {mine && (
        <p className="text-[11.5px] text-slate-500 mb-4">
          ...
          {mine.verified
            ? " and Verified."
            : " — shown as Unverified until platform operations confirms your TIN."}
        </p>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-5">
        {profiles.rows.map((p) => (
          <div
            key={p.id}
            className="border border-slate-200/70 rounded-xl px-3.5 py-3 flex items-start justify-between gap-2"
          >
            <div className="min-w-0">
            ...
            {p.verified ? (
              <span className="text-[10px] font-medium px-2 py-0.5 rounded-full bg-[#16A34A]/10 text-[#16A34A] shrink-0 flex items-center gap-1">
        ...
        {!profiles.loading && profiles.rows.length === 0 && (
          <p className="col-span-full text-[12px] text-slate-400 text-center py-4">
            No businesses in the directory yet — be the first.
          </p>
        )}
        {profiles.loading && (
          <p className="col-span-full text-[12px] text-slate-400 text-center py-4">Loading...</p>
        )}
      </div>
      ...
      {showRfqForm && (
        <div className="border border-slate-200/70 rounded-xl p-3.5 mb-3 grid grid-cols-1 sm:grid-cols-2 gap-2">
          <input
            ...
            placeholder="What do you need? e.g. 500 bags of cement"
          />
          <input
            className={inputClass}
            value={rfqDraft.category}
            onChange={(e) => setRfqDraft({ ...rfqDraft, category: e.target.value })}
            placeholder="Category e.g. Construction materials"
          />
          <input
            className={inputClass}
            value={rfqDraft.qty}
            onChange={(e) => setRfqDraft({ ...rfqDraft, qty: e.target.value })}
            placeholder="Quantity / spec notes"
          />
          <input
            type="date"
            className={inputClass}
            value={rfqDraft.deadline}
            onChange={(e) => setRfqDraft({ ...rfqDraft, deadline: e.target.value })}
          />
          <input
            className={inputClass}
            value={rfqDraft.contact}
            onChange={(e) => setRfqDraft({ ...rfqDraft, contact: e.target.value })}
            placeholder="Contact for quotes — phone or email"
          />
          <button
            onClick={postRfq}
            disabled={!rfqDraft.title.trim()}
            className="btn-primary text-white text-[12px] font-medium rounded-lg px-3.5 py-2 disabled:opacity-40"
          >
            Publish RFQ to the network
          </button>
        </div>
      )}
      <div className="space-y-2">
        {rfqs.rows.slice(0, 8).map((r) => (
          <div
            key={r.id}
            className="border border-slate-200/70 rounded-xl px-3.5 py-2.5 flex items-center justify-between gap-3"
          >
            <div className="min-w-0">
              <p className="text-[12.5px] font-medium text-[#111827] truncate">{r.title}</p>
        ...
        {!rfqs.loading && rfqs.rows.length === 0 && (
          <p className="text-[12px] text-slate-400 text-center py-4">
            No open RFQs — post the first request for quotation.
          </p>
        )}
      </div>
    </section>
...
export function SecurityDashboard({ currentUser }) {
  ...
  useEffect(() => {
    const bioStaff = Object.keys(window.localStorage).filter((k) =>
      k.startsWith("bs_bio_cred_"),
    ).length;
    setDevice({
      lock: !!window.localStorage.getItem("bs_app_lock_hash"),
      bioLock: !!window.localStorage.getItem("bs_bio_applock"),
      bioStaff,
    });
  }, []);
  const rows = [
    {
      ok: true,
      label: "Zero-Trust data layer",
      detail:
        "Row Level Security enabled and policied on every table — 90+ policies, each scoped to the session's company, audited in sections 59 and 74.",
    },
    {
      ok: true,
      label: "RBAC",
      detail: `15 real roles gate the sidebar, global search, quick actions, and marketplace from one source of truth. You are signed in as ${currentUser?.role || "—"}.`,
    },
    {
      ok: true,
      label: "Encryption",
      detail:
        "TLS in transit and AES-256 at rest via Supabase (platform property, stated as such). App Lock PIN stored only as a SHA-256 hash; WebAuthn keys never leave their device.",
    },
    {
      ok: true,
      label: "Audit trail",
      detail:
        "Real audit_log table written by workflows, security events, and system actions — append-only by design (no updated_at, deliberately: section 74).",
    },
    {
      ok: device.lock,
      label: "App Lock on this device",
      detail: device.lock
        ? `PIN active${device.bioLock ? " with biometric unlock enrolled" : " — biometric unlock available to enroll above"}.`
        : "Off — enable it above for shared devices.",
    },
    {
      ok: device.bioStaff > 0,
      label: "Device management (this device)",
      detail: `${device.bioStaff} staff biometric enrollment(s) on this device. Honest scope: a cross-device registry needs server-side device records — real future work; today each device manages its own enrollments, like physical terminals do.`,
    },
    {
      ok: false,
      label: "2FA (TOTP)",
      detail:
        "Not yet enrolled — Supabase GoTrue ships a real MFA factors API, so authenticator-app 2FA is a genuine integration away. Named, not faked with a switch that does nothing.",
    },
    {
      ok: false,
      label: "ABAC",
      detail:
        "Attribute-based rules beyond roles (time, location, record-owner) are real future work on top of the working RBAC layer.",
    },
  ];
  return (
    <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
      ...
      <p className="text-[12.5px] text-slate-500 mt-1 mb-4">
        Real posture — every green row is checkable right now; every amber row is named work, never
      ...
      <div className="space-y-2.5">
        {rows.map((r) => (
          <div key={r.label} className="flex items-start gap-2.5">
            ...
            <div>
              <p className="text-[12.5px] font-medium text-[#111827]">{r.label}</p>
...
export const MARKETPLACE_PACKS = [
  {
    id: "payroll",
    label: "Payroll Plugin",
    icon: Wallet,
    modules: ["hr"],
    blurb:
      "Real payroll runs, PAYE/SDL/WCF via the Tax Center, leave and attendance — the full HR module.",
  },
  {
    id: "restaurant",
    label: "Restaurant Module",
    icon: Store,
    modules: ["sales", "inventory", "hr", "finance"],
    blurb: "Counter POS, perishable stock with real audits, shift staff, daily books.",
  },
  {
    id: "hospital",
    label: "Hospital Module",
    icon: HeartPulse,
    modules: ["inventory", "crm", "sales", "finance"],
    blurb:
      "Expiry-tracked stock, patient/client records via CRM, billing. Clinical records are real future work.",
  },
  {
    id: "school",
    label: "School Module",
    icon: BookOpen,
    modules: ["crm", "projects", "finance", "hr"],
    blurb: "Students-as-CRM, programs-as-projects, fees, staff. Gradebooks are real future work.",
  },
  {
    id: "construction",
    label: "Construction Module",
    icon: HardHat,
    modules: ["projects", "procurement", "manufacturing", "inventory", "finance"],
    blurb:
      "Job sites as projects, materials procurement, equipment via Fixed Assets — this platform's deepest pack.",
  },
  {
    id: "agriculture",
    label: "Agriculture Module",
    icon: Package,
    modules: ["inventory", "procurement", "finance", "sales"],
    blurb:
      "Inputs and harvest stock, supplier lead times, seasonal cash flow via the real month-view reports.",
  },
  {
    id: "hotel",
    label: "Hotel Module",
    icon: Building2,
    modules: ["sales", "inventory", "hr", "finance", "crm"],
    blurb:
      "Front-desk billing, housekeeping stock, guest records via CRM. Room-night booking is real future work.",
  },
  {
    id: "pharmacy",
    ...
    blurb:
      "Expiry dates and batch tracking are already real in Inventory — this pack turns on exactly what dispensing needs.",
  },
  {
    id: "transport",
    label: "Transport Module",
    icon: Truck,
    modules: ["inventory", "procurement", "finance", "crm"],
    blurb:
      "Fuel and parts stock, supplier terms, client contracts. Fleet telematics is real future work.",
  },
  {
    id: "ngo",
    label: "NGO Module",
    icon: Users,
    modules: ["finance", "projects", "crm", "hr"],
    blurb:
      "Programs as projects, donors via CRM, budget-vs-actual per category via the real Budgets tab.",
  },
  {
    id: "manufacturing",
    label: "Manufacturing Module",
    icon: Layers,
    modules: ["manufacturing", "inventory", "procurement", "finance"],
    blurb:
      "BOMs, work orders, QC, machine maintenance — the real Manufacturing module plus its supply chain.",
  },
  {
    id: "retail-pos",
    label: "Retail POS",
    ...
    blurb:
      "Counter POS with real receipts, barcode-ready stock, daily books — the lean shop bundle.",
  },
  {
    id: "fuel",
    label: "Fuel Station",
    icon: Cog,
    modules: ["sales", "inventory", "finance", "hr"],
    blurb:
      "Shift sales via POS, fuel-as-stock with audits, attendants on payroll. Pump/tank telemetry is real future work.",
  },
  {
    id: "church",
    label: "Church Module",
    icon: Landmark,
    modules: ["finance", "crm", "projects", "hr"],
    blurb:
      "Offerings via the real Other Income tab, members via CRM, programs as projects, staff and volunteers via HR.",
  },
  {
    id: "saccos",
    label: "Cooperative (SACCOS)",
    icon: Wallet,
    modules: ["finance", "crm", "analytics"],
    blurb:
      "Members via CRM, real lending via the Finance Loans ledger with repayments. Dividend computation is real future work.",
  },
  {
    id: "realestate",
    label: "Real Estate",
    icon: Building2,
    modules: ["crm", "projects", "finance", "sales"],
    blurb:
      "Properties as projects, tenants via CRM, rent as real recurring invoices via Subscriptions.",
  },
  {
    id: "lawfirm",
    label: "Law Firm",
    ...
    blurb:
      "Matters as projects, clients via CRM, real invoicing. Billable-hours time tracking is real future work.",
  },
  {
    id: "insurance",
    label: "Insurance",
    icon: ShieldCheck,
    modules: ["crm", "sales", "finance", "analytics"],
    blurb:
      "Policies as real Subscriptions with renewal dates, claims tracked as tickets, commissions via the ledger.",
  },
  {
    id: "cardealer",
    label: "Car Dealership",
    icon: Truck,
    modules: ["inventory", "sales", "crm", "finance"],
    blurb:
      "Units as high-value stock, buyers via CRM, real invoicing. Per-vehicle serial/VIN tracking is real future work.",
  },
  {
    id: "salon",
    label: "Beauty Salon",
    icon: Sparkles,
    modules: ["sales", "hr", "inventory", "finance"],
    blurb:
      "Service sales via POS, stylists on payroll with real attendance, product stock. Appointment booking is real future work.",
  },
  {
    id: "distribution",
    label: "E-commerce & Distribution",
    icon: Package,
    modules: ["inventory", "procurement", "sales", "crm", "finance"],
    blurb:
      "Multi-warehouse stock with transfers and the heat map, supplier terms, order-to-cash. A customer-facing storefront is real future work.",
  },
];
...
export function MarketplaceSection({ enabledModules, onToggleModule, canManage }) {
  function installPack(pack) {
    ...
    notify(
      missing.length === 0
        ? `${pack.label} was already fully enabled.`
        : `${pack.label} installed — ${missing.length} module(s) enabled. Nothing in the core was touched.`,
    );
  }
  return (
    <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
      ...
      <p className="text-[12.5px] text-slate-500 mt-1 mb-4">
        Industry packs — each installs a curated bundle of this platform&apos;s real modules for
        that business, without touching the core. There&apos;s deliberately no "uninstall pack":
        packs share modules, so removing one could silently break another — disable individual
        modules in the Modules section below instead, where you can see exactly what each switch
        controls.
      </p>
          ...
          return (
            <div key={p.id} className="border border-slate-200/70 rounded-xl p-4 flex flex-col">
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                {installed ? (
                  <span className="text-[11.5px] font-medium text-[#16A34A] flex items-center gap-1">
                  ...
                  <button
                    ...
                    disabled={!canManage}
                    title={canManage ? "" : "Only managers can install packs"}
                    className="btn-primary text-white text-[11.5px] font-medium rounded-lg px-3 py-1.5 disabled:opacity-40"
                  >
                    Install
                  </button>
                )}
...
export function DataExportManager({ exportData, company }) {
  ...
  function exportAll() {
    ...
    try {
      ...
      addSheet(
        "Customers & Leads",
        ["Company", "Contact", "Stage", "Value (TZS 000)", "Email", "Phone"],
        (exportData.crm?.rows || []).map((l) => [
          l.company,
          l.name,
          l.stage,
          l.value,
      ...
      addSheet(
        "Invoices",
        ["Invoice No", "Customer", "Date", "Status", "Amount Paid (TZS 000)"],
        (exportData.invoices?.rows || []).map((i) => [
          i.id,
          i.customer,
          i.date,
          i.status,
      ...
      addSheet(
        "Expenses",
        ["Vendor", "Category", "Date", "Due Date", "Amount (TZS 000)", "Status"],
        (exportData.expenses?.rows || []).map((e) => [
          e.vendor,
          e.category,
          e.date,
          e.dueDate,
      ...
      addSheet(
        "Inventory",
        ["SKU", "Name", "Category", "Qty on Hand", "Unit Cost (TZS 000)"],
        (exportData.inventory?.rows || []).map((it) => [
          it.sku,
          it.name,
          it.category,
          it.qty,
      ...
      addSheet(
        "Employees",
        ["Name", "Role", "Department", "Status", "Salary (TZS 000)", "Hire Date"],
        (exportData.employees?.rows || []).map((e) => [
          e.name,
          e.role,
          e.department,
          e.status,
      ...
      addSheet(
        "POS Transactions",
        ["Receipt No", "Date", "Cashier", "Method", "Items"],
        (exportData.posTransactions?.rows || []).map((t) => [
          t.id,
          t.date,
          t.cashier,
          t.method,
      ...
      addSheet(
        "Suppliers",
        ["Name", "Contact", "Email", "Phone", "Category", "Lead Time (days)"],
        (exportData.suppliers?.rows || []).map((s) => [
          s.name,
          s.contactPerson,
          s.email,
          s.phone,
      ...
      XLSX.writeFile(
        wb,
        `${(company.name || "company").replace(/\s+/g, "-").toLowerCase()}-full-export-${TODAY.toISOString().slice(0, 10)}.xlsx`,
      );
    ...
    <section className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-5 sm:p-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[12.5px] text-slate-500 mt-1">
            Your data is yours — one real Excel workbook with 7 sheets covering your core operating
            data: customers, invoices, expenses, inventory, employees, POS transactions, and
            suppliers ({totalRecords} records right now). Not literally every internal table, and
            honest about that — this is the data a business actually takes with it.
          </p>
        </div>
        <button
          onClick={exportAll}
          disabled={busy}
          className="btn-primary text-white text-[12.5px] font-medium px-4 py-2.5 rounded-lg flex items-center gap-1.5 shrink-0 disabled:opacity-50"
        >
